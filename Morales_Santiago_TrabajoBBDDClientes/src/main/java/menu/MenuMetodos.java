    ...
    public static void menu(){
        Integer opcion = null;
            ...
            if (ClientesDAO.getConexion() == null) {
                System.err.println("El programa ha finalizado: error en la conexión.");
                System.exit(1);
            }
            ...
            while (true) {
                try {
                    ...
                    System.out.print("Opción introducida[puede introducir 0 para salir]: ");
                    ...
                    System.err.println("\nError: El dato introducido no es válido " + nfe.getMessage() + "\n");
                }
            }
        }
        ...
        public static void visualizar(){
            ...
            while (true) {
                try {
                    ...
                    System.out.print("\nOpción introducida [introduzca 0 para volver]: ");
                    opcion = Integer.parseInt(sc.nextLine());
                    ...
                    case 2:
                        if(start!=1){
                            ...
                            System.out.println("Esta visualizando los primeros registros");
                        }
                        break;
                    default:
        ...
        public static POJO existe() {
            ...
            System.out.print("Indica el ID del empleado que desea buscar: ");
        ...
        public static void borrar() {
            ...
            if (cliente != null) {
                    System.out.println("\n¿Está seguro de que desea eliminar el siguiente usuario?"
                            + "\n  " + cliente);
